...
//        userInfoEntity.setUserBirthday(userInfoDTO.getUserBirthday()==null?new java.util.Date():DateUtils.parse(userInfoDTO.getUserBirthday(),DateUtils.FORMAT_LONG));
        ...
        userAuthorityEntity.setUserId(userInfoEntity.getUserId());
        userAuthorityEntity.setRoleId(userInfoDTO.getRoleId());
        userAuthorityEntity.setCreateOn(new java.util.Date());
        authorityRepository.addUserAurhority(userAuthorityEntity);
        return "ok";
    }
